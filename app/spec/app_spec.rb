...
RSpec.describe '../app.rb' do
  ...
  context 'when not logged in' do
    it 'redirects unauthenticated users to the login page' do
      ...
      follow_redirect!
      expect(last_request.path).to eq('/dashboard') # Expect redirect to login
    end
  end
  ...
  context 'Form to Add Question' do
    before do
      ...
      @question = Question.create(description: 'Question', lesson_id: 1)
    end
    ...
    it 'shows an error if the question already exists' do
      post '/admin_panel/add_questions', {
        ...
        lesson_id: 1,
        correct_option: '1',
        option_description_1: '1',
        option_description_2: '2',
        option_description_3: '3',
        option_description_4: '4'
      }
      expect(last_response).to be_ok
