...
RSpec.describe '../app.rb' do
  ...
  context 'Change user settings' do
    before(:each) do
      @progress = Progress.create!
      @user = User.create(username: 'new_user', password: 'oldpassword', email: 'oldemail@example.com',
  ...
  context 'change password' do
    ...
    it 'password changed successfully' do
      post '/user/change_password', current_password: 'password', new_password: 'new_password',
